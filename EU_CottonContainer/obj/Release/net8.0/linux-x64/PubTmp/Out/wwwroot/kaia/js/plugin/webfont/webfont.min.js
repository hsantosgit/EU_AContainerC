...
"use strict"; (function () {
    ...
    function t(a, b, c) {
        ...
        for (e = 0; e < d.length; e += 1) {
            f = !1; for (g = 0; g < c.length; g += 1)if (d[e] === c[g]) { f = !0; break } f || b.push(d[e])
        }
    ...
    function v(a) {
        if ("string" === typeof a.fa) return a.fa; var b = a.k.location.protocol; "about:" == b && (b = a.F.location.protocol); return "https:" == b ? "https:" : "http:"
    }
    ...
    function x(a, b, c) {
        ...
        var e = !1, f = !0, g = null, l = c || null; ca ? (b.onload = function () { e = !0; d() }, b.onerror = function () { e = !0; g = Error("Stylesheet failed to load"); d() }) : setTimeout(function () { e = !0; d() }, 0); s(a, "head", b)
